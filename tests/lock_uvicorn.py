...
lorem_file = "tests/bufferdir/" + lorem_checksum
lorem_lock = lorem_file + ".LOCK"
...
os.environ["HASHSERVER_LOCK_TIMEOUT"] = "5"
...
try:
    ...
    lorem_lockp = pathlib.Path(lorem_lock)
    lorem_lockp.touch()
